![Header](https://capsule-render.vercel.app/api?type=waving&color=0d1117&height=300&section=header&text=DevOps%20&%20SRE%20Engineer&fontSize=50&fontAlignY=38&desc=Bridging%20the%20gap%20between%20Code%20&%20Infrastructure&descAlignY=55&descAlign=50&animation=fadeIn)

<div align="center">

  <h3> 🚀 Automating the Unpredictable </h3>
  <p>
    I am a <strong>DevOps Engineer</strong> with a strong foundation in <strong>Web Development</strong>. 
    <br>
    I don't just deploy code; I understand how it's built. My focus is on creating resilient, scalable infrastructure and seamless CI/CD pipelines.
  </p>
...
My stack combines the precision of **Infrastructure as Code** with the creativity of **Full Stack Development**.
...
*Understanding the dev side is crucial for effective ops.*
<br>
...
* **Infrastructure as Code:** Building reusable modules with **Terraform**.
* **Orchestration:** Managing microservices clusters with **Kubernetes**.
